<template>
    <div class="flex w-screen h-screen">
      <div class="w-2/5 relative">
        <img :src="currentImage" class="h-full w-full object-cover absolute inset-0 z-0" />
...
<script>
import movie2 from '@/assets/vuemovie2.png';
import movie3 from '@/assets/vuemovie3.png';
